...
LangGraph-based ReAct agent with four-layer architecture, trust kernel, governance services, and dynamic model routing. Python 3.11+, LiteLLM for model calls, Jinja2 for prompts, Pydantic for validation.
