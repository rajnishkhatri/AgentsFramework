...
class TestIdentityContext:
    ...
    def test_rejects_missing_provider(self):
        with pytest.raises(ValidationError):
            IdentityContext(principal_id="x", display_name="x", account_id="x")

    def test_rejects_missing_principal_id(self):
        with pytest.raises(ValidationError):
            IdentityContext(provider="aws", display_name="x", account_id="x")
...
class TestPolicyBinding:
    ...
    def test_rejects_missing_policy_id(self):
        with pytest.raises(ValidationError):
            PolicyBinding(policy_name="x", policy_type="managed", provider="aws")
