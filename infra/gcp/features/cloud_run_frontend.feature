# infra/gcp/features/cloud_run_frontend.feature
#
# Recipe 5 — terraform-compliance BDD scenarios for the Next.js frontend.
#
...
#
# Static checks live in tests/infra/gcp/test_cloud_run_frontend.py and
# infra/gcp/policies/cloud_run.rego.

Feature: Frontend Cloud Run service satisfies Recipe 5 Tier A constraints
    ...
    Scenario: Service uses a dedicated frontend runtime SA
