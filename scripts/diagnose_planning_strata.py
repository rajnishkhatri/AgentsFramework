...
CASES: list[tuple[str, str, str]] = [
    ...
    ("L0", "single-action", "Read the first line of /workspace/notes.txt and print it."),
    ("L0", "single-action", "Echo the phrase quarterly review verbatim."),
    ("L0", "single-action", "Overwrite /workspace/status.txt with the single character OK."),
...
def main() -> None:
    ...
    for intended, family, prompt in CASES:
        fired, reason = select_planning_depth(task_input=prompt, task_tool_results_count=0)
