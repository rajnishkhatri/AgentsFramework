...
import {
  ...
  CorrelationHealthSchema,
  ComplianceBundleSchema,
  ComplianceSummarySchema,
  WorkflowIntegritySummarySchema,
  LogRowSchema,
...
const ZOD_MIRRORS: Record<string, ZodObject<ZodRawShape>> = {
  ...
  ValidatorStatResponse: ValidatorStatSchema,
  GuardrailFailureResponse: GuardrailFailureSchema,
  GuardrailSummaryResponse: GuardrailSummarySchema,
  CapabilityResponse: CapabilitySchema,
  PolicyResponse: PolicySchema,
  AgentCardResponse: AgentCardSchema,
  AgentAuditEntryResponse: AgentAuditEntrySchema,
  IntegrityReportResponse: IntegrityReportSchema,
  CorrelationHealthResponse: CorrelationHealthSchema,
  ComplianceBundleResponse: ComplianceBundleSchema,
  WorkflowIntegritySummaryResponse: WorkflowIntegritySummarySchema,
  ComplianceSummaryResponse: ComplianceSummarySchema,
  LogRowResponse: LogRowSchema,
