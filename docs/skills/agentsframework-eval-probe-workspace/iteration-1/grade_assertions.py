...
ASSERTIONS = {
    "eval-0-plan-builder-trace-altitude": [
        ...
        ("Does NOT jump straight to a 1-5 Likert judge", lambda t: (not re.search(r"1[\-–]5 (scale|likert|rating)", t, re.I), "no 1-5 likert found")),
    ],
    ...
    "eval-2-which-seam-next-prioritizer": [
        ...
        ("Notes the meta/analysis.py aggregator is not yet built", any_of(r"not yet", r"planned deliverable", r"does not yet|doesn'?t yet|still a planned")),
