...
description: >-
  ...
  these failures in one place", "code this strata set", or wants to turn a coded
  JSONL into a reviewable Langfuse dataset. This is the OPERATIONAL companion to
...
> **Docs mirror.** This folder versions the skill with the repo for PR review and
> discovery. The conceptual pipeline lives in
