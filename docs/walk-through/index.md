...
- [Agentic-Engineering Harness — Step-by-Step Best-Practice Walkthrough (Tracks A/B/C)](07_agentic_engineering_harness_walkthrough.md) — Goal: stand up, exercise, and verify the full agent harness — sensors/hooks (A), eval-validation discipline (B: TPR/TNR + pass^k + paired-bootstrap + graduation), and intent-debt gates + per-folder AGENTS.md (C) — as one end-to-end, copy-pasteable procedure.
