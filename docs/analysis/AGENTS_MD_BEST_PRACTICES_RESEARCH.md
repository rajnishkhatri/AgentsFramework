---
type: analysis
title: 'AGENTS.md Best Practices Research'
...
5. **Add @-mentions** — reference `@docs/style-guides/STYLE_GUIDE_LAYERING.md` and `@docs/style-guides/STYLE_GUIDE_PATTERNS.md` for deep context
