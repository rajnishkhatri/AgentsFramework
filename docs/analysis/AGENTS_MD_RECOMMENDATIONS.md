---
type: analysis
title: 'AGENTS.md Improvement Recommendations'
description: 'Analysis method: Pyramid Principle / MECE structured evaluation'
tags: [analysis]
---
...
**Source document:** `docs/analysis/AGENTS_MD_BEST_PRACTICES_RESEARCH.md`
...
|---|---|---|---|
| AMP-1 | **@-mentions for deep context** | Amp manual: `@docs/style.md`; keeps AGENTS.md lean while providing deep context on demand | Replace Key Documents table with @-mentions: `@docs/style-guides/STYLE_GUIDE_LAYERING.md`, `@docs/style-guides/STYLE_GUIDE_PATTERNS.md` |
