...
| Trust kernel rules                               | [Chapter 3](#3-five-layers-one-cheat-sheet-twelve-tests-that-enforce-it) (table row 1); deep dive in `[docs/FOUR_LAYER_ARCHITECTURE.md](FOUR_LAYER_ARCHITECTURE.md)` and `[docs/TRUST_FRAMEWORK_ARCHITECTURE.md](TRUST_FRAMEWORK_ARCHITECTURE.md)`                                                                                |
