# Governance recipes — bundle index
...
- [Recipe 9 — Arming the coach answer-leakage gate (off → shadow → enforce)](09_coach_leakage_gate_arming_runbook.md) — Operational procedure to promote the Phase-5 coach leakage gate from off to shadow to enforce, with the wiring prerequisite, shadow-observation gate, promotion criteria, rollback, and fail-open alerting.
