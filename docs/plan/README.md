...
For the architectural rules these plans target, see [docs/Architectures/FOUR_LAYER_ARCHITECTURE.md](../Architectures/FOUR_LAYER_ARCHITECTURE.md), [docs/style-guides/STYLE_GUIDE_LAYERING.md](../style-guides/STYLE_GUIDE_LAYERING.md), [docs/style-guides/STYLE_GUIDE_PATTERNS.md](../style-guides/STYLE_GUIDE_PATTERNS.md), and the workspace-wide rules in [AGENTS.md](../../AGENTS.md).
