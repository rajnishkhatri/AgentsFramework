...
| Phases 3–6 | ⬜ NOT STARTED | Phase 3 human-gated on ≥100 **coded** turns/mode; blockers cleared. OPEN human decisions: (a) does synthetic dev-runner traffic count toward the coding corpus, or wait for production shadow traffic; (b) if synthetic counts, expand utterance/question banks before batch 2 (avoid near-duplicates) |
