...
| **3.3** | **HUMAN — open coding** (≥100 turns/mode from export) via open-coding skill | `docs/research/coach_phase2_open_coding.md`, `coach_step1_open_code_inventory.csv` | FR-G3.1 | 3.2b |
| **3.4** | **HUMAN — axial taxonomy** — 5–6 categories, IAA ≥ 0.80 | `docs/research/coach_phase3_axial_coding.md`, `coach_evaluation_pipeline_open_axial_coding_rubric.md` | FR-G3.2–G3.3 | 3.3 |
...
| Human gates explicit | ✅ 3.3, 3.4, 3.7c |
