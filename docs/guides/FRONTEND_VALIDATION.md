---
type: guide
title: 'Frontend UI Manual Validation Script'
description: 'A QA-facing checklist for certifying a frontend release by hand.'
tags: [guide]
---
...
Pairs with [docs/style-guides/STYLE_GUIDE_FRONTEND.md](STYLE_GUIDE_FRONTEND.md) §11
...
in [docs/style-guides/STYLE_GUIDE_FRONTEND.md §22](STYLE_GUIDE_FRONTEND.md). Each item
...
Pass: [ ] YES  [ ] NO
Source: [docs/style-guides/STYLE_GUIDE_FRONTEND.md §22 FE-AP-7](STYLE_GUIDE_FRONTEND.md).
...
[docs/style-guides/STYLE_GUIDE_FRONTEND.md §11](STYLE_GUIDE_FRONTEND.md).
- **FE-AP-1…FE-AP-20** — frontend anti-patterns in
[docs/style-guides/STYLE_GUIDE_FRONTEND.md §22](STYLE_GUIDE_FRONTEND.md).
...
[docs/style-guides/STYLE_GUIDE_FRONTEND.md §20](STYLE_GUIDE_FRONTEND.md).
...
- [docs/style-guides/STYLE_GUIDE_FRONTEND.md](STYLE_GUIDE_FRONTEND.md) — canonical
