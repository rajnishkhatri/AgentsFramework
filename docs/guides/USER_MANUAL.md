---
type: guide
title: 'User Manual -- Run one query against the ReAct agent'
description: 'You have a clone of this repo and Python 3.10 or newer.'
tags: [guide]
---
...
| Trust kernel / `AgentFacts`     | This manual does not cover internals; see `[docs/guides/DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md)` chapter on the trust foundation.                                                                                               |
...
| Extending the agent             | This is a user manual; for extension recipes see `[docs/guides/DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md)`.                                                                                                                        |
| Architecture overview           | `[docs/Architectures/FOUR_LAYER_ARCHITECTURE.md](FOUR_LAYER_ARCHITECTURE.md)` and `[docs/style-guides/STYLE_GUIDE_LAYERING.md](STYLE_GUIDE_LAYERING.md)`.                                                                                           |
...
*See also:* `[docs/guides/DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md)` (extending the framework), `[docs/analysis/PYRAMID_ANALYSIS.md](PYRAMID_ANALYSIS.md)` (the planning artifact behind both manuals), `[AGENTS.md](../../AGENTS.md)` (the workspace conventions).