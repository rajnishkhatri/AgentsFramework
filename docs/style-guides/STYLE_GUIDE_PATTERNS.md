---
type: style-guide
title: 'Style Guide: Design Patterns for Agentic Systems'
description: 'A comprehensive catalog of design patterns for building agentic systems using composable horizontal and vertical layers.'
tags: [style-guide]
---
