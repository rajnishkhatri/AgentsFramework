---
type: style-guide
title: 'Style Guide: Frontend Ring for Agentic Systems'
description: 'A prescriptive style guide for the cross-process Frontend Ring that sits above agent_ui_adapter/ and the four-layer backend.'
tags: [style-guide]
---
