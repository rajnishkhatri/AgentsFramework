...
title: 'ADR-0031: Hint.choice_letter + uniqueness (question_id, choice_letter, rung); rung 4 stays off wire'
status: accepted
created: 2026-07-17
updated: 2026-07-17
...
# ADR-0031: `Hint.choice_letter` + uniqueness `(question_id, choice_letter, rung)`
