...
Located at [frontend/e2e/fixtures/scenarios.ts](frontend/e2e/fixtures/scenarios.ts). Each scenario is an array of `AGUIEvent` objects that mirrors Appendix B of [docs/guides/FRONTEND_VALIDATION.md](../guides/FRONTEND_VALIDATION.md):
...
All of SS2 (feature checks) and SS3 (security checks) from [docs/guides/FRONTEND_VALIDATION.md](../guides/FRONTEND_VALIDATION.md), except:
...
No mocks. Playwright talks to a running frontend that proxies to a real Python middleware + agent runtime. These are the tests from SS1 (smoke) and SS5 (sign-off gate 5) in [docs/guides/FRONTEND_VALIDATION.md](../guides/FRONTEND_VALIDATION.md).
