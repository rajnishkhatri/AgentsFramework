...
- `docs/CLOUD_COMPARISON_PYRAMID_ANALYSIS.md` — the Pyramid-Analysis planning artifact behind `CLOUD_PROVIDER_COMPARISON.md`. Three pyramids (one per workload tier) with evidence tables citing public pricing pages, eight-check validation logs, and the SCQA framing-notes appendix.
